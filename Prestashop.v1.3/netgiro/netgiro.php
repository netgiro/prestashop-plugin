...
if (!defined('_CAN_LOAD_FILES_'))
	...
	class netgiro extends PaymentModule
	{
		...
		function __construct()
		{
			...
			$this->description = $this->l('Accepts payments using Debitcard by Netgíró.');
		...
		public function hookpaymentReturn($params)
		{
			...
			if ($state == _PS_OS_PAYMENT_)
			{
				$smarty->assign(array(
					...
					'netgiro_invoiceNumber' => nl2br2($nrow['netgiro_invoice_number']),
					'netgiro_confirmationcode' => nl2br2($nrow['netgiro_confirmation_code']),
					'status' => 'ok',
