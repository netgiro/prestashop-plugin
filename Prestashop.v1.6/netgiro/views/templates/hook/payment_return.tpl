<p>
	<img src="{$this_path}logo.gif" width="100" height="33"/>
</p>
{if $status == 'ok'}
	<p>{l s='Pöntun þín hjá' mod='netgiro'} <span class="bold">{$shop_name}</span> {l s='hefur verið móttekin.' mod='netgiro'}
		<br /><br />
		{l s='Netgíró reikningur verður sendur í netbankann þinn. ' mod='netgiro'}
		...
		<br /><br />- {l s='Netgíró staðfestingarkóði: ' mod='netgiro'} <span class="bold">{$netgiro_invoiceNumber}</span>
